...
# Generates a bag of words vectos based on 
# the number of word occurances in the review
...
preds_out = FP_BASE + num_reviews + '_train_' + num_test_reviews + '_test_count_class.p'
pickle.dump((preds, test_stars), open(preds_out, 'wb'))
preds_proba_out = FP_BASE + num_reviews + '_train_' + num_test_reviews + '_test_count_proba.p'
...
report_fp = 'reports/count_report_' + num_reviews + '_train_' + num_test_reviews + '_test.json'
